    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coverage_type', models.CharField(blank=True, max_length=50)),
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='patient_images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mode', models.CharField(choices=[('in_person', 'In-Person'), ('video_call', 'Video Call'), ('phone_call', 'Phone Call')], max_length=10)),
                ('is_completed', models.BooleanField(default=False)),
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appointments', to='app1.doctor')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appointments', to='app1.patient')),
            ],
        ),
    ]
